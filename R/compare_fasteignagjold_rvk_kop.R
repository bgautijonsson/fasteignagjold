...
p <- crossing(
  ...
  mutate(
    ...
    Kópavogsbær = 0.00278 * fasteignamat,
    Reykjavíkurborg = 19046 + 736.34 * fm + 0.0018 * fasteignamat,
    Garðabær = 0.00313 * fasteignamat,
...
ggsave(
  plot = p,
  filename = here("Figures", "compare_fasteignagjold_rvk_kop.png"),
